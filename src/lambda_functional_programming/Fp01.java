...
public class Fp01 {
    ...
    public static void main(String[] args) {
        ...
        getMinElement01(liste);
        getMinElement02(liste);
    ...
    // 2) Çift sayı olan list elementlerini aynı satırda aralarında boşluk
    // bırakarak yazdıran bir method oluşturun.(Structured)
    ...
    // ÖDEV: 8) List elemanları arasından en küçük değeri bulan bir method oluşturun.(2 Yol ile)
    // 1. yol:
