...
public class Fp05 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("ortalamaPuanlarVerilenSayidanBuyukMu(coursesList,10): "+ortalamaPuanlarVerilenSayidanBuyukMu(coursesList, 10));
        System.out.println("herhangiBirKursAdiKelimeyiIceriyorMu(coursesList,\"Turkish\"): "+herhangiBirKursAdiKelimeyiIceriyorMu(coursesList, "Turkish"));
        ortalamaPuaniEnYuksekOlanKursAdiniYazdir(coursesList);
    ...
    public static void ortalamaPuaniEnYuksekOlanKursAdiniYazdir(List<Courses> list){
