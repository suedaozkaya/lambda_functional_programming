...
public class Fp03 {
    public static void main(String[] args) {
        ...
        System.out.println();
        // buyukHarfleYazdir02(liste); // bu method listeyi degistiriyor
        // System.out.println(liste);
        ...
        System.out.println("xIleBasliyorMu(liste): " + hicbiriXIleBaslamiyorMu(liste));
    ...
    // list mutable olduğu için elemanları
    // işlemden sonra kalıcı değişiğinden comment out yaptık
